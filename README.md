...
# License
All code in this repo is MIT licensed, apart from the web fonts, which are are licensed separately under the Open Font License. See the LICENSE.MD file in `/assets/fonts/` for details.
